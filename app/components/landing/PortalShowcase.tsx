...
const features: { icon: ReactNode; title: string; desc: string; color: string; iconBg: string }[] = [
  {
    ...
    desc: "Agenda sempre à mão. Marque ou transfira sessões num clique.",
    color: "text-teal",
  ...
  },
  {
    ...
    desc: "Um histórico claro do seu processo e das anotações que construirmos.",
  ...
  },
  {
    ...
    desc: "Acerto de sessões via PIX ou Cartão, sem planilhas ou papelada.",
  ...
  },
  {
    ...
    title: "Documentos",
    desc: "Recibos pra reembolso e materiais de apoio salvos num só lugar.",
    color: "text-accent",
  ...
  },
  {
    ...
    desc: "Atualização rápida sobre sua semana antes de nos encontrarmos.",
  ...
  },
  {
    ...
    desc: "Respire fundo: um ambiente preparado para você desacelerar antes de entrar.",
    color: "text-teal",
    iconBg: "bg-teal/10 ring-teal/20",
  },
];
