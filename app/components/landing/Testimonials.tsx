...
export function Testimonials() {
  return (
    <section className="py-20 lg:py-28 px-5 md:px-8 bg-bg-warm">
      <div className="max-w-7xl mx-auto">
        <AnimatedSection direction="up">
          <div className="section-label">Depoimentos</div>
          <h2 className="section-title">Histórias de Transformação</h2>
        </AnimatedSection>
        <AnimatedSection direction="up" delay={0.15} staggerChildren={0.12} staggerType="premium" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 mt-12">
          {testimonials.map((t, i) => (
            <AnimatedItem key={i} direction="up" staggerType="premium">
              <GlassCard variant="strong" className="border-l-[3px] border-l-accent relative">
                ...
                <p className="text-sm text-txt-light leading-relaxed italic mb-4">&ldquo;{t.quote}&rdquo;</p>
